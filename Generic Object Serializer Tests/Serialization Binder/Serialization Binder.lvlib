...
<Library LVVersion="17008000">
	...
	<Item Name="Read - Warning Input - Returns Default Serialization Binder.vi" Type="VI" URL="../Read - Warning Input - Returns Default Serialization Binder.vi"/>
	<Item Name="Read - Warning Input - Returns Same Warning.vi" Type="VI" URL="../Read - Warning Input - Returns Same Warning.vi"/>
	<Item Name="Write - Error Input - Returns Same Error.vi" Type="VI" URL="../Write - Error Input - Returns Same Error.vi"/>
	<Item Name="Write - Warning Input - Returns Same Warning.vi" Type="VI" URL="../Write - Warning Input - Returns Same Warning.vi"/>
	<Item Name="Write Custom Serialization Binder Then Read - Returns Same Object.vi" Type="VI" URL="../Write Custom Serialization Binder Then Read - Returns Same Object.vi"/>
	<Item Name="Write Serializaton Binder Base Class Then Read - Returns Default Serialization Binder.vi" Type="VI" URL="../Write Serializaton Binder Base Class Then Read - Returns Default Serialization Binder.vi"/>
</Library>
