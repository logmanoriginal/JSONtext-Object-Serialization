...
<Library LVVersion="17008000">
	...
	<Item Name="LVObject to JSON - Default - LabVIEW Extensions Enabled.vi" Type="VI" URL="../LVObject to JSON - Default - LabVIEW Extensions Enabled.vi"/>
	<Item Name="LVObject to JSON - False - LabVIEW Extensions Disabled.vi" Type="VI" URL="../LVObject to JSON - False - LabVIEW Extensions Disabled.vi"/>
	<Item Name="LVObject to JSON - True - LabVIEW Extensions Enabled.vi" Type="VI" URL="../LVObject to JSON - True - LabVIEW Extensions Enabled.vi"/>
</Library>
